...
dn_model = decompose(data, partitions, myforms[2], NetDecOPF.build_acopf_with_free_lines, extra_ref_extensions=[NetDecOPF.ref_add_global_bus!])
...
BM.set_parameter(LM.params, "ncuts_per_iter", 1)
